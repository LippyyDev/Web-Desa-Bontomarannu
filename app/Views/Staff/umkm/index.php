...
.ua-approve { color: #10b981; background: #ecfdf5; }
.ua-approve:hover { background: #d1fae5; color: #059669; }
.ua-reject  { color: #f59e0b; background: #fffbeb; }
.ua-reject:hover  { background: #fef3c7; color: #d97706; }
...
<div class="mb-4 mt-2 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2">
        <div class="d-flex align-items-center bg-white border px-3 search-bar-container" style="width:260px;height:38px;border-radius:.5rem;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUmkm    = '<?= base_url('/staff/umkm/') ?>';
    let currentPage   = 1;
    let totalPages    = 1;
    let isLoading     = false;
    let searchTimeout;
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
                <div class="umkm-card h-100" style="cursor:pointer;" onclick="window.location.href='${baseUmkm}${item.id}'">
                    ...
                    <div class="umkm-card-body">
                        ...
                        <div class="umkm-meta">
                            <div class="umkm-meta-item"><i class="bi bi-person"></i><span>${escapeHtml(item.pemilik)}</span></div>
                            <div class="umkm-meta-item"><i class="bi bi-telephone"></i><span>${escapeHtml(item.kontak || '-')}</span></div>
