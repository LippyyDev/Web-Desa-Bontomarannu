...
<div class="mb-4 mt-2 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?= base_url('/staff/umkm/' . $umkm['id'] . '/edit') ?>" class="btn btn-success" title="Edit UMKM"><i class="bi bi-pencil-square me-1"></i> Edit UMKM</a>
        <?php endif; ?>
    ...
    <div class="tab-pane fade" id="produk-pane" role="tabpanel" aria-labelledby="produk-tab" tabindex="0">
        ...
        <div class="row g-3 mb-4 mt-1">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <a href="<?= base_url('/staff/umkm/produk/' . $p['id']) ?>" class="text-decoration-none">
