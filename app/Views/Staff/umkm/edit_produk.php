...
<div class="mb-4 mt-2 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    <div>
        ...
        <p class="text-muted fs-6 mb-0" style="max-width: 600px;">Ubah nama, harga, deskripsi, atau foto produk.</p>
    </div>
    <div class="d-flex gap-2">
        <a href="<?= base_url('/staff/umkm/' . $produk['umkm_id'] . '/edit') ?>" class="btn btn-outline-success">Kembali</a>
    </div>
</div>

<div class="row g-4">
    <div class="col-lg-8">
        <form method="POST" action="<?= base_url('/staff/umkm/produk/' . $produk['id']) ?>" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= base_url('/staff/umkm/' . $produk['umkm_id'] . '/edit') ?>" class="btn btn-outline-secondary">Batal</a>
            </div>
        </form>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm border-0 sticky-top" style="top: 80px;">
            <div class="card-body">
                ...
                <p class="text-muted small">Perubahan pada produk akan <strong>langsung tersimpan</strong> tanpa perlu persetujuan ulang.</p>
                <hr>
                <a href="<?= base_url('/staff/umkm/produk/' . $produk['id'] . '/hapus') ?>"
