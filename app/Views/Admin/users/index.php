...
function loadCards(page = 1) {
    ...
    $.ajax({
                    ...
                    <div class="account-card">
                        ...
                        <div class="account-card-body">
                            ...
                            <div class="account-card-actions">
                                ...
                                <a href="<?= base_url('/admin/akun/') ?>${account.id}/hapus" class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus akun ini?')">
        ...
        error: function() {
            ...
            console.error('Error loading accounts data');
        }
    });
}
                    ...
                    { 
                        ...
                        render: function(data) {
                            return '<div class="btn-group" role="group">' +
                                ...
                                '<a href="<?= base_url('/admin/akun/') ?>' + data + '/hapus" class="btn btn-sm btn-outline-danger" onclick="return confirm(\'Hapus akun ini?\')"><i class="bi bi-trash"></i> Hapus</a>' +
                                '</div>';
                        }
                    }
                ],
