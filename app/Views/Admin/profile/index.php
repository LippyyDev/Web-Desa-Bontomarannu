    ...
    <div class="card-body pt-4 px-4 pb-4">
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="content-security" role="tabpanel">
                ...
                <form method="post" action="<?= base_url('/admin/profil/pertanyaan-keamanan') ?>">
                    <?= csrf_field() ?>
                    <div class="row g-3">
                        <div class="col-12">
                ...
                <?php if ($hasSQ): ?>
                <form id="formHapusPertanyaan" method="post" action="<?= base_url('/admin/profil/pertanyaan-keamanan') ?>" style="display:none;">
                    <?= csrf_field() ?>
