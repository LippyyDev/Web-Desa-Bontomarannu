...
<div class="mb-4 mt-2 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    ...
    <div class="d-flex gap-2">
        <a href="<?= base_url('/user/umkm/produk/' . $produk['id'] . '/edit') ?>" class="btn btn-success">
            <i class="bi bi-pencil-square me-1"></i>Edit Produk
        </a>
        <a href="<?= base_url('/user/umkm/' . $umkm['id']) ?>" class="btn btn-outline-success">
            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    ...
                    <div class="info-value">
                        <a href="<?= base_url('/user/umkm/' . $umkm['id']) ?>" class="text-success text-decoration-none">
                            <?= esc($umkm['nama_toko']) ?>
                        </a>
                    </div>
                </div>
