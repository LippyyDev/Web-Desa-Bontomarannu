...
<div class="mb-4 mt-2 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2">
        ...
        <a href="<?= base_url('/user/umkm/' . $umkm['id'] . '/hapus') ?>" onclick="return confirm('Hapus toko ini secara permanen?')" class="btn btn-outline-danger"><i class="bi bi-trash"></i> Hapus Toko</a>
    </div>
</div>
...
<div class="alert alert-info border-0 shadow-sm">
    <i class="bi bi-clock me-2"></i> Toko Anda sedang <strong>ditinjau</strong>. Anda tetap dapat melakukan perubahan.
</div>
<?php endif; ?>
            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-medium">Kontak (WhatsApp/HP)</label>
...
function addEcommerce() {
    ...
    div.innerHTML = `
        <div class="col-md-4"><input type="text" name="ecommerce_platform[]" class="form-control" placeholder="Shopee / dll"></div>
        <div class="col-md-7"><input type="url" name="ecommerce_url[]" class="form-control" placeholder="https://..."></div>
        <div class="col-md-1 d-flex align-items-center"><button type="button" class="btn btn-outline-danger btn-sm" onclick="removeRow(this)"><i class="bi bi-trash"></i></button></div>
    `;
