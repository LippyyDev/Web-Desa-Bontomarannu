...
<div class="mb-4 mt-2 d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3">
    <div>
        ...
        <h2 class="fw-bold text-dark mb-2" style="font-size: 2.2rem; letter-spacing: -0.5px;">
            Profil <span style="color: #15803d;">Saya</span>
        </h2>
        <p class="text-muted fs-6 mb-0" style="max-width: 600px;">Perbarui informasi data diri Anda.</p>
    </div>
</div>
    ...
    <div class="card-body pt-4 px-4 pb-4">
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="content-info" role="tabpanel">
                <form method="post" enctype="multipart/form-data" action="<?= base_url('/user/profil') ?>" id="formProfil">
                    <?= csrf_field() ?>
                    <div class="row g-3">
                        <div class="col-md-4">
            ...
            <div class="tab-pane fade" id="content-security" role="tabpanel">
                ...
                <form method="post" action="<?= base_url('/user/profil/pertanyaan-keamanan') ?>">
                    <?= csrf_field() ?>
                    <div class="row g-3">
                        <div class="col-12">
                ...
                <?php if ($hasSQ): ?>
                <form id="formHapusPertanyaan" method="post" action="<?= base_url('/user/profil/pertanyaan-keamanan') ?>" style="display:none;">
                    <?= csrf_field() ?>
