...
class ProfileController extends ProtectedController
{
    ...
    public function updateSecurityQuestion()
    {
        ...
        if ($question === '' && $answer === '') {
            ...
            return redirect()->to('/admin/profil')->with('success', 'Pertanyaan keamanan dihapus.');
        }

        if ($question === '') {
            return redirect()->to('/admin/profil')->with('error', 'Pertanyaan keamanan tidak boleh kosong.');
        }
        if ($answer === '') {
            return redirect()->to('/admin/profil')->with('error', 'Jawaban tidak boleh kosong.');
        }
        ...
        return redirect()->to('/admin/profil')->with('success', 'Pertanyaan keamanan berhasil disimpan.');
    }
}
